...
ТЕМАТИЧЕСКИЙ ФИЛЬТР — извлекай ТОЛЬКО новости по темам:
1. ЗАКОНОДАТЕЛЬСТВО и РЕГУЛИРОВАНИЕ: законы, постановления, нормативные акты, требования к перевозчикам, лицензирование, тахографы, весогабаритный контроль, штрафы
2. ТЕХНОЛОГИИ и ИННОВАЦИИ: мониторинг транспорта, ГЛОНАСС/GPS, телематика, автоматизация, цифровизация логистики, беспилотные грузовики, электротранспорт
3. ПРОИСШЕСТВИЯ: ДТП с участием грузовиков/автобусов, аварии на трассах, пожары на транспорте, нарушения ПДД
4. ПРОЧЕЕ связанное с автотранспортом: грузоперевозки, автопарки, топливо, дороги, перевозка пассажиров автобусами, транспортные компании

ПРАВИЛА:
1. Извлекай МАКСИМУМ 15 самых свежих новостей (не больше!)
2. СТРОГО ФИЛЬТРУЙ: пропускай новости не связанные с автотранспортом (авиация, ж/д, морской транспорт — НЕ включать, если нет связи с автоперевозками)
3. Игнорируй: меню, футеры, рекламу, пресс-релизы компаний не из транспортной отрасли
