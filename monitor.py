...
- Изменения в РОЗНИЧНЫХ МЕДИЦИНСКИХ услугах (клиники, лечение, диагностика)
- Туризм, гражданская авиация, железная дорога, морской транспорт (если не связано с автоперевозками)
- Социальные программы, благотворительность, благодарности
- Технические изменения: дизайн, дата, счётчики без нового контента
- Поздравления, праздничный контент
- Общие новости о компании без отношения к её B2B продуктам
...
- УСЛОВИЯ: сбой системы, обновление функций, новые API, интеграции
- ЦЕНЫ: акции, скидки, тарифы, спецпредложения для корпоративных клиентов
- ПАРТНЁРСТВА: интеграция с логистическими ПО, ГРУЗОВЫМИ платформами, транспортом
...
- summary начинай СРАЗУ С СУТИ: "Добавлен...", "Обновлено...", "Запущена...", "Новый...", "Изменены..."
- НЕ ПИШИ "воду" и выводы. Только факты. Запрещено писать:
  * "В новой версии сайта..." — НЕ УПОМИНАЙ про версии сайта вообще
  * "Изменения не обнаружены..." — если нет изменений, просто is_meaningful: false
...
- Если нет значимых изменений — верни is_meaningful: false с пустым summary ""
...
2. "prices" — акция, скидка, спецпредложение, изменение цен/тарифов
3. "news" — партнёрство, мероприятие, сертификация, важное объявление
4. "technical" — только дизайн/структура сайта без нового контента

ФОРМАТ ОТВЕТА (только JSON, без пояснений):
{{
    "category": "products|prices|news|technical",
    "summary": "Начинай сразу с глагола: Добавлен/Обновлено/Запущена/Новый. НЕ пиши 'В новой версии сайта'. Если нет изменений — пустая строка. 2-3 предложения.",
    "tags": ["тег1", "тег2"],
    "is_meaningful": true/false
}}

ТЕГИ: новый_продукт, оборудование, тахографы, мониторинг, ПО, видео, акция, скидка, интеграция, обновление, партнёрство, wialon, глонасс"""
